...
public class ControllerLogger
{
    ...
    public void before(JoinPoint jp)
    {
        ...
        System.out.println("被拦截方法调用之前调用此方法，输出此语句" + jp.getTarget().getClass().getName() + "." + jp.getSignature().getName());
    }

    public void after(JoinPoint jp)
    {
        System.out.println("被拦截方法调用之后调用此方法，输出此语句.." + jp.getTarget().getClass().getName() + "." + jp.getSignature().getName());
    }
