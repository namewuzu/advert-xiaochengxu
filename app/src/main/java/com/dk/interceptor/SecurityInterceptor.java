...
public class SecurityInterceptor implements HandlerInterceptor
{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception
    {
       ...
       /* if (url.indexOf("/login") != -1)
        ...
        if (url.indexOf("/getAllVedioClass") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
        if (url.indexOf("/getContentsByClass") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
        if (url.indexOf("/bandPhone") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
        if (url.indexOf("/wxAuthSetPassword") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
        ...
        if (url.indexOf("/getAuthorVedios") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
        if (url.indexOf("/getAuthorVoById") != -1)
        {// 如果要访问的资源是不需要验证的
            return true;
        }
