package com.dk.util.weixin.sdk;

import com.dk.util.weixin.sdk.WXPayConstants.SignType;
...
//        }
     ...
     * @throws Exception
     */
    public Map<String, String> fillEnterPayRequestData(Map<String, String> reqData) throws Exception {
     ...
     * @throws Exception
     */
     public Map<String, String> processResponseXmlNoSigin(String xmlStr) throws Exception {
     ...
     * @throws Exception
     */
    public Map<String, String> enterPrisedOrder(Map<String, String> reqData) throws Exception {
        return this.enterPrisedOrder(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String, String> enterPrisedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.ENTERPRISE_PAY_URL;
        String respXml = this.requestWithCert(url, this.fillEnterPayRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXmlNoSigin(respXml);
    }
