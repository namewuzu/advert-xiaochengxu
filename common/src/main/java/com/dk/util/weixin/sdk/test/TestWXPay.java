...
public class TestWXPay {
    ...
    public TestWXPay() throws Exception {
        config = WXPayConfigImpl.getInstance(false,null);
    ...
    public void doUnifiedOrder() {
        ...
        data.put("openid", "ojzN2wI7XJnOPy47xU9qIpqyQJSY");
        data.put("device_info", "");
        data.put("fee_type", "CNY");
        data.put("total_fee", "1");
        data.put("notify_url", "http://www.7bhealth.com");
...
//        data.put("transaction_id", "4008852001201608221962061594");
    ...
    public void doGetSandboxSignKey() throws Exception {
        WXPayConfigImpl config = WXPayConfigImpl.getInstance(false,null);
        HashMap<String, String> data = new HashMap<String, String>();
