...
import com.dk.util.weixin.pay.WXPayConstants.SignType;
...
public class WXPay {
    private Logger log = LoggerFactory.getLogger(WXPay.class);
    ...
    public  Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        String nostr = WXPayUtil.generateNonceStr();
        reqData.put("nonce_str",nostr );
        log.info("随机字符串=************************************"+nostr);
        ...
        log.info("this signType="+this.signType+"****sign_type=************************************"+reqData.get("sign_type"));
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
        log.info("key=&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"+config.getKey());
        log.info("sign=************************************"+WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
        return reqData;
    }
